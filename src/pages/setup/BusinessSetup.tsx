      ...
      <div className={`flex-1 flex flex-col mt-8 transition-opacity duration-200 ${transitioning ? 'opacity-0' : 'opacity-100'}`}>
        ...
        {step === 2 && (
          <div className="space-y-5 flex-1 flex flex-col">
            ...
            <div className="space-y-4 flex-1">
              <div
                className="border-2 border-dashed rounded-xl h-40 flex flex-col items-center justify-center gap-2 cursor-pointer hover:bg-accent/50 transition-colors"
                onClick={() => {
                  // TODO: Implement image upload
                  setBookingImage('/placeholder.svg');
                }}
              >
                <Upload className="h-8 w-8 text-muted-foreground" />
                <p className="text-sm text-muted-foreground">Upload header image</p>
              </div>
        ...
        {step === 3 && (
          <div className="space-y-5 flex-1 flex flex-col">
            ...
            <Button onClick={handleFinish} className="w-full h-12 rounded-full gap-2" disabled={!accountHolder || !accountNumber}>
